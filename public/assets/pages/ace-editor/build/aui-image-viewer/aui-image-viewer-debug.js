...
/**
 * <p><img src="assets/image/aui-image-viewer-base/main.png"/></p>
 *
...
var ImageViewer = A.Component.create(
	{
		...
		ATTRS: {
			...
			/**
			 * Image node element used to load the image.
			 *
			 * @attribute image
			...
			/**
			 * Preload all image grabbed from the <a
		...
		prototype: {
			...
			loadImage: function(src) {
				...
				// dataURI allows cached image to refire load event in webkit, and bypass
			...
			/**
			 * Removes the references to the preload image to free up memory
			 *
...
/**
 * <p><img src="assets/image/aui-image-viewer-gallery/main.png"/></p>
 *
 * A base class for ImageGallery, providing:
 * <ul>
 *    <li>Widget Lifecycle (initializer, renderUI, bindUI, syncUI, destructor)</li>
 *    <li>Displays an image in a Overlay</li>
 *    <li>Displays list of thumbnails of the image as a control</li>
