...
YUI.add('dd-drag', function(Y) {
    ...
    */
    ...
    Y.extend(Drag, Y.Base, {
        ...
        * @description The function we use as the ondragstart handler when we start a drag in Internet Explorer. This keeps IE from blowing up on image as drag handles.
