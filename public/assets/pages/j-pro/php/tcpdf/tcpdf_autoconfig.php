...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(K_PATH_MAIN.'examples/image/', K_PATH_MAIN.'image/', '/usr/share/doc/php-tcpdf/examples/image/', '/usr/share/doc/tcpdf/examples/image/', '/usr/share/doc/php/tcpdf/examples/image/', '/var/www/tcpdf/image/', '/var/www/html/tcpdf/image/', '/usr/local/apache2/htdocs/tcpdf/image/', K_PATH_MAIN);
