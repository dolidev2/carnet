...
class PHPMailer
{
     ...
     * This can include image, sounds, and just about any other document type.
     * These differ from 'regular' attachmants in that they are intended to be
     * displayed inline with the message, not just attached for download.
     * This is used in HTML messages that embed the image
     ...
     * This can include image, sounds, and just about any other document type.
     * Be sure to set the $type to an image type for image:
     * JPEG image use 'image/jpeg', GIF uses 'image/gif', PNG uses 'image/png'.
     ...
     * Automatically makes modifications for inline image and backgrounds
    ...
    public function msgHTML($message, $basedir = '', $advanced = false)
    {
        ...
        if (isset($images[2])) {
            foreach ($images[2] as $imgindex => $url) {
                // do not change urls for absolute image (thanks to corvuscorax)
