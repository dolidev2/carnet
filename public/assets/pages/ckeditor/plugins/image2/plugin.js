	...
	function setupResizer( widget ) {
		...
		resizer.on( 'mousedown', function( evt ) {
			var image = widget.parts.image,
				...
				// "factor" can be either 1 or -1. I.e.: For right-aligned image, we need to
			...
			function onMouseMove( evt ) {
				...
				// This is to prevent image to visually disappear.
...
/**
 * CSS classes applied to aligned image. Useful to take control over the way
 * the image are aligned, i.e. to customize output HTML and integrate external stylesheets.
 *
