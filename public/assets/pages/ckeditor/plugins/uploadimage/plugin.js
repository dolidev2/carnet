...
( function() {
	CKEDITOR.plugins.add( 'uploadimage', {
		...
		init: function( editor ) {
			...
			// Handle image which are available in the dataTransfer.
			...
			// Handle image which are not available in the dataTransfer.
			...
			editor.on( 'paste', function( evt ) {
				...
				for ( i = 0; i < imgs.count(); i++ ) {
					...
					// We are not uploading image in non-editable blocs and fake objects (#13003).
	...
	/**
	 * The URL where image should be uploaded.
	 *
	 * @since 4.5
