        ...
        <div class="page-wrapper">
            ...
            <div class="page-header">
                <div class="page-header-title">
                    ...
                    <button class="btn btn-outline-primary btn-lg" data-toggle="modal" data-target="#ressource-Modal">Ressource</button>
                    <span>Liste des entrees et sorties </span>
                </div>
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="<?= URL ?>stock">Parametre</a>
                        </li>
                        <li class="breadcrumb-item"><a href="<?= URL ?>stock">Stock</a>
                        </li>
                        <li class="breadcrumb-item"><a href="<?= URL ?>stock">Ressource</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="card-block">
                                <div class="row mb-3">
                                    <h5  class="col-sm-6 offset-sm-4 form-label">
                                        ...
                                        <?php if (isset($item['debut']) && isset($item['fin'])): ?>
                                            <span><?= date("d-m-Y",strtotime($item['debut']))  ?></span> au
                                            <span><?= date("d-m-Y",strtotime($item['fin']))  ?></span>
                                        <?php endif; ?>
                                    </h5>
                                </div>
                            </div>
                                            ...
                                            <?php $i=1; foreach ($stocks as $stock):?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php elseif ($stock['type_stock'] == 'sorti'): ?>
                                                            <button class="btn btn-success">Sortie</button>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td>
                                ...
                                <div class="modal-body">
                                    <form  method="post" action="<?= URL ?>stock/av">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Prix En Gros</label>
                                            <div class="col-sm-8">
                                                <input type="number"  name="prix_g" id="prix_g" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Prix Au Détail</label>
                                            <div class="col-sm-8">
                                                <input type="number"  name="prix_d" id="prix_d" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Quantité</label>
                                            <div class="col-sm-8">
                                                <input type="number"  name="qte_stock" id="qte_stock" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Description</label>
