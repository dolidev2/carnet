            ...
            <div class="page-body">
                <div class="card">
                    <div class="card-block">
                        <form method="post"  action="<?= URL ?>client/info/<?= $client ?>/statistique_frequence_annee ?>">
                            <div class="row mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12" style="min-height: 500px; width: 100%;">
                                <div id="chart_div" ></div>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-6" style="min-height: 500px;">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ["Année ",  "Chiffre d'Affaire","Chiffre d'Affaire Entreprise"],
            ...
            var options = {
                title: 'Fréquence de Couture <?= date("Y") ?>',
                curveType: 'function',
...
<?php if (isset($year) &&!empty($year)): ?>
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ["Année ",  "Chiffre d'Affaire","Chiffre d'Affaire Entreprise"],
                <?php for ($i=0; $i < count($data_choose); $i++): ?>
                ['<?= $data_choose[$i]['mois'] ?>',        <?= $data_choose[$i]['montant'] ?>,  <?= $data_choose[$i]['chiffre'] ?>],
                <?php endfor; ?>
            ]);

            var options = {
                title: 'Fréquence de Couture <?= $year ?>',
                curveType: 'function',
                legend: { position: 'bottom' }
            };
