...
<script src="<?= URL ?>public/bower_components/jquery-ui/js/jquery-ui.min.js"></script>
...
<!-- classie js -->
<script type="text/javascript" src="<?= URL ?>public/bower_components/classie/js/classie.js"></script>
<!-- Rickshow Chart js -->
<script src="<?= URL ?>public/bower_components/d3/js/d3.js"></script>
<script src="<?= URL ?>public/bower_components/rickshaw/js/rickshaw.js"></script>
<!-- Morris Chart js -->
<script src="<?= URL ?>public/bower_components/raphael/js/raphael.min.js"></script>
<script src="<?= URL ?>public/bower_components/morris.js/js/morris.js"></script>
<!-- Horizontal-Timeline js -->
<script type="text/javascript" src="<?= URL ?>public/assets/pages/dashboard/horizontal-timeline/js/main.js"></script>
<!-- amchart js -->
<script type="text/javascript" src="<?= URL ?>public/assets/pages/dashboard/amchart/js/amcharts.js"></script>
<script type="text/javascript" src="<?= URL ?>public/assets/pages/dashboard/amchart/js/serial.js"></script>
<script type="text/javascript" src="<?= URL ?>public/assets/pages/dashboard/amchart/js/light.js"></script>
<script type="text/javascript" src="<?= URL ?>public/assets/pages/dashboard/amchart/js/custom-amchart.js"></script>
<!-- i18next.min.js -->
...
<!-- Custom js -->
<script type="text/javascript" src="<?= URL ?>public/assets/pages/dashboard/custom-dashboard.js"></script>
<script type="text/javascript" src="<?= URL ?>public/assets/js/script.js"></script>
<script src="<?= URL ?>public/assets/pages/data-table/js/data-table-custom.js"></script>

<!-- pcmenu js -->
<script src="<?= URL ?>public/assets/js/pcoded.min.js"></script>
<script src="<?= URL ?>public/assets/js/demo-12.js"></script>
